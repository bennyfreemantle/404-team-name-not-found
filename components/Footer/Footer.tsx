...
export default function Footer() {
  return (
    <div
      data-testId="footer"
      className="bg-slate-900 z-10 w-full flex flex-col gap-5 p-6"
    >
      ...
      <div className="flex gap-4 justify-center">
        <button
          data-testId="chrome"
          className="w-35 p-2 bg-slate-700 rounded-xl text-amber-50 flex items-center border border-amber-50"
        >
